...
const seedData = async () => {
    ...
    pino_js_1.logger.info('Seeding initial data with full 5-10 questions per game...');
    ...
    pino_js_1.logger.info('Database seeded successfully with all 8 games and 5-10 questions each! Zero dummy students.');
};
