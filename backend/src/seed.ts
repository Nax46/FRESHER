...
export const seedData = async () => {
  ...
  logger.info('Seeding initial data with strictly 4 games and full questions...');
  ...
  logger.info('Database seeded successfully with strictly 4 games and full questions! Zero dummy students.');
};
